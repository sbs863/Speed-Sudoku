...
ip.broadcast = function broadcast() {
  var address = ip.address();
  var netmask = findNetmaskByAddress(address);
  var subnet = ip.subnet(address, netmask);
  return subnet.broadcastAddress;
}

function findNetmaskByAddress(address) {
  var devices = os.networkInterfaces();
  var deviceNames = Object.keys(devices);
  
  var interfaces = [];
  deviceNames.forEach(function (deviceName) {
    interfaces = interfaces.concat(devices[deviceName]);
  });
  var interface = interfaces.find(function (interface) {
